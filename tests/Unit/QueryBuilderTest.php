...
final class QueryBuilderTest extends TestCase
{
    ...
    public function testGetSendsRequestAction(): void
    {
        ...
        $this->assertSame(Action::Request, $captured->action);
    ...
    private function builder(?string $from = null): QueryBuilder
    {
        $transport = $this->createMock(TransportInterface::class);
        $config = new Config(apiKey: 'test-key');
        $client = new DilovodClient($config, $transport);
    ...
    private function builderWithResponse(ResponseData $response, ?string $from = null): QueryBuilder
    {
        $transport = $this->createMock(TransportInterface::class);
