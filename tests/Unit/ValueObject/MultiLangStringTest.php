...
final class MultiLangStringTest extends TestCase
{
    ...
    {
        $str = new MultiLangString('Товар', 'Товар RU');
    ...
    {
        $ukOnly = new MultiLangString('Тільки UK');
        $ruOnly = new MultiLangString(null, 'Только RU');
    ...
    {
        $this->assertSame('UK', (string) new MultiLangString('UK', 'RU'));
        $this->assertSame('RU', (string) new MultiLangString(null, 'RU'));
