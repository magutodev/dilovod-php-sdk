...
final class OrderBuilder
{
    ...
    private bool $autoPlacement = false;

    /** @var array<string, mixed>|null */
    private ?array $deliveryData = null;
    ...
    public function supplyDate(DateTimeInterface|string $date): self
    {
     ...
     */
    public function headerField(string $key, mixed $value): self
    {
